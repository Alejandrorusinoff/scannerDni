...
const CovidEmployeeData1 = ({navigation, route}) => {
  ...
  /* asi llega cuando creo al empleado
  console.log(route.params.data.empleado) */
  /* console.log(dni, employeeId) */

  /* console.log(route.params.data)
  
  const dni = route.params.data.dni
  const employeeId = route.params.data._id */
